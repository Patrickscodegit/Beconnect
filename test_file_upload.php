...
use App\Services\Robaws\RobawsApiClient;
...
try {
    ...
    echo "✅ RobawsApiClient accessible\n";
} catch (\Exception $e) {
    echo "❌ RobawsApiClient error: " . $e->getMessage() . "\n";
}
...
// Check RobawsApiClient upload methods
$apiReflection = new ReflectionClass(RobawsApiClient::class);
$apiMethods = $apiReflection->getMethods(ReflectionMethod::IS_PUBLIC);
