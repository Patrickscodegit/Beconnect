            ...
            <form action="{{ route('public.quotations.store') }}" method="POST" enctype="multipart/form-data" 
                ...
                <div class="p-8 border-b">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                        ...
                        <div>
                            <label for="in_transit_to" class="block text-sm font-medium text-gray-700 mb-2">
                                In Transit To
                            </label>
                            <select id="in_transit_to" name="in_transit_to"
                                ...
                                @foreach(\App\Services\Countries\CountryService::getCountryOptions() as $value => $label)
                                    <option value="{{ $value }}" {{ old('in_transit_to', $prefill['in_transit_to'] ?? '') == $value ? 'selected' : '' }}>
                                        {{ $label }}
                                    </option>
                                @endforeach
                            </select>
