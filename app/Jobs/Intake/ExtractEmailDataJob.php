...
use App\Services\Extraction\Strategies\EmlExtractionStrategy;
...
class ExtractEmailDataJob implements ShouldQueue
{
    ...
    public function handle(): void
    {
        ...
        try {
            ...
            // Extract email data using specialized strategy
            ...
            if ($extractionResult->success) {
                ...
                throw new \Exception("Email extraction failed: {$extractionResult->error}");
            }
