...
final class RobawsApiClient implements RobawsApiClientInterface
{
    ...
    /**
     * Partially update an existing quotation/offer in Robaws (merge patch)
     */
    public function patchQuotation(string $quotationId, array $payload, ?string $idempotencyKey = null): array
    {
        $headers = [
